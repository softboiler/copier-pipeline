...
<!-- Please verify the issue is present in the latest version by installing it with `pip install copier_pipeline==2024.2.0` and checking that the bug is still there #} -->

- [ ] This bug affects version `2024.2.0` of `copier_pipeline`.
