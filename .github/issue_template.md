...
<!-- Please verify the issue is present in the latest version by installing it with `pip install copier-pipeline==2025.1.3` and checking that the bug is still there #} -->

- [ ] This bug affects version `2025.1.3` of `copier-pipeline`.
