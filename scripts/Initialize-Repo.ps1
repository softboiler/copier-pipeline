...
if ($Fresh) {
    if ( !(git remote) ) {
        git remote add origin 'https://github.com/blakeNaccarato/copier-pipeline.git'
    ...
    gh repo edit --homepage 'https://blakeNaccarato.github.io/blakeNaccarato/copier-pipeline/'
}
